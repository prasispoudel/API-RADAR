...
# composite index for endpoint + timestamp (use column names to avoid class attribute resolution issues at import time)
Index('ix_test_runs_endpoint_timestamp', 'endpoint_id', 'timestamp')
